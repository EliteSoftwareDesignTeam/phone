...
public class TextInterpreter {
    ...
    private ArrayList<String> TESTcommands;
    ...
    private void init() {
        ...
        TESTcommands.add("bluetooth");
        TESTcommands.add("connection working");
        TESTcommands.add("is everything (ok|working)");
    ...
    public Command Interpret(List<String> texts) {
        ...
        for (String text : texts) {
            ...
            if (matched) break;
            for (String regex : TESTcommands) {
                Pattern pattern = Pattern.compile(regex);
                Matcher m = pattern.matcher(text);
                if (m.find()) {
                    System.out.println("TI: " + "STOP command");
                    command.reInit(CommandType.TEST_CONNECTION, "");
                    matched = true;
                    break;
                }
            }
